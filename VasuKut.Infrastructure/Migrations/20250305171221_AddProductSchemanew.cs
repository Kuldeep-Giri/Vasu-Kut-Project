...
{
    /// <inheritdoc />
    public partial class AddProductSchemanew : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NearestPort = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DispatchDays = table.Column<int>(type: "int", nullable: false),
                    MinPricePerUnit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaxPricePerUnit = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceRanges_Products_ProductId",
