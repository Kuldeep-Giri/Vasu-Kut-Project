...
namespace VasuKut.Infrastructure.Interfaces
{
    ...
    {
        Task<(List<UserManagementResponce> users, int totalCount, int activeUserCount, int inactiveUserCount)> GetAllUsersAsync(int pageNumber, int pageSize, string? search="", string? role = "",
            string? status = "");
